...
export default function Contact() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 md:px-18 lg:px-24 xl:48 md:py-12">
      <ContactForm />
      <article className="flex flex-col py-32 mx-6 gap-6">
        <h1 className="text-center text-4xl md:text-4xl lg:text-5xl font-extrabold mb-6">
          Contactanos
        </h1>
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-8 gap-4">
          <FaWhatsapp className="w-10 h-10 fill-green-600" />
          <div>
            <h3 className="text-xl font-bold mb-2">Nuestros Whatsapp:</h3>
        ...
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-8 gap-4">
          <MailIcon className="w-10 h-10 text-dk_primary" />
          <div>
        ...
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-8 gap-4">
          <FaLinkedinIn className="w-10 h-10 fill-blue-600" />
          <div>
