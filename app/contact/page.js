...
export default function Contact() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 md:px-18 lg:px-24 xl:48 md:py-12">
      <ContactForm />
      <article className="flex flex-col md:py-12 2xl:py-28 mx-6 sm:gap-6 md:gap-4 2xl:gap-6">
        <h1 className="text-center text-2xl md:text-4xl 2xl:text-5xl font-extrabold mb-2 md:mb-6">
          Contactanos
        </h1>
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-6 2xl:p-8 gap-4">
          <FaWhatsapp className="md:w-8 md:h-8 2xl:w-10 2xl:h-10 fill-green-600" />
          <div>
        ...
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-6 2xl:p-8 gap-4">
          <MailIcon className="md:w-8 md:h-8 2xl:w-10 2xl:h-10 text-dk_primary" />
          <div>
        ...
        <div className="flex flex-col shadow-xl shadow-black/15 bg-white dk:text-white rounded-lg p-4 md:p-6 2xl:p-8 gap-4">
          <FaLinkedinIn className="md:w-8 md:h-8 2xl:w-10 2xl:h-10 fill-blue-600" />
          <div>
