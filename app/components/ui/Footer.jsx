...
const Footer = () => {
  return (
    <footer className="flex flex-col w-full items-center pt-8 md:pt-12 pb-2 md:pb-4 px-8 md:px-24 gap-4 md:gap-8 ">
        <div>
            <Link href={'/'}>
                <Image 
        ...
        <div className="flex items-center gap-16">
            ...
            <div className='flex gap-8'>
                ...
                <Link href={'/'}>
                    <FaWhatsapp size={32} className='transition hover:text-secondary hover:scale-125'/>
                </Link>
                <Link href={'/'}>
